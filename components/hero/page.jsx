    ...
    >
      <div className="absolute inset-0 bg-black bg-opacity-50 z-10">
        <div className="relative z-20 container mx-auto px-10 pt-20 lg:pt-40 ">
          <h1 className="w-[50%] lg:w-[100%] pt ml-auto text-[30px] lg:text-[80px] text-right text-primary  font-bold">
            Pure Clean Solutions
          </h1>
          <div className="w-[50%] lg:w-[700px] mt-10 lg:mt-20 ml-auto text-center font-bold">
